...
/**
 * Get the global rules directory (~/.cursor/rules)
 */
...
/**
 * Get the project rules directory (.cursor/rules in project root)
 */
export function getProjectRulesDir(cwd: string = process.cwd()): string {
